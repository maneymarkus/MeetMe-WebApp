var Module = (function(window, document, undefined) {
    ...
    function init() {
        ...
        var userUrl = "http://localhost:8080" + window.location.pathname + "api/user";
        var postUrl = "http://localhost:8080" + window.location.pathname + "api/post";
        ...
        function postPosting(e) {
            ...
            var author = authorIn.innerHTML;
            var content = contentIn.innerHTML;
            authorIn.innerHTML = "";
            contentIn.innerHTML = "";
            var xhttp = new XMLHttpRequest();
            xhttp.onreadystatechange = function() {
